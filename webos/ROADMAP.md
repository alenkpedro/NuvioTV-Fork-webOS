...
4. **Descoberta e metadados — primeira entrega 0.9.** Descobrir com filtros,
   ...
   **Prioridade do usuário:** implementar a tela de pausa com elenco; depois dados de intro/outro e miniaturas, antes das demais áreas. A tabela de paridade mantém os recursos pendentes.
