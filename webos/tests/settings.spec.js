...
test('playback groups follow the fork, keep the port toggles working and mark Android-only rows', async ({ page }) => {
  ...
  await expect(page.locator('.settings-content .settings-group-title')).toHaveText(['Geral', 'Pular automaticamente', 'Player e Seleção de Fontes', 'Legendas', 'Reprodução automática']);
