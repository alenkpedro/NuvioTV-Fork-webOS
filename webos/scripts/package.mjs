...
const result = spawnSync(process.execPath, ['node_modules/@webos-tools/cli/bin/ares-package.js', ...(args.length ? args : ['--no-minify', 'dist', '-o', 'packages'])], { stdio: 'inherit', env: { ...process.env, APPDATA: cliData } });
