...
const manifest = {
  ...
  appDescription: 'Trailer tocando dentro do app e serviço de rede local com cabeçalhos.',
...
const index = { paging: { page: 1, count: 1, maxPage: 1, itemsTotal: 1 }, packages: [{ id: app.id, title: app.title, iconUri: manifest.iconUri, manifest, pool: 'main', shortDescription: 'Player do fork com trailer no app, coleções no tamanho do fork e serviço de rede.' }] };
