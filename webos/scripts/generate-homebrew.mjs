...
const manifest = {
  ...
  appDescription: 'Buffer e Rede: buffer inicial e após travamento e teste de velocidade real.',
...
const index = { paging: { page: 1, count: 1, maxPage: 1, itemsTotal: 1 }, packages: [{ id: app.id, title: app.title, iconUri: manifest.iconUri, manifest, pool: 'main', shortDescription: 'Player do fork com buffer, medição de fonte, reprodução automática e legendas para LG webOS 24.' }] };
