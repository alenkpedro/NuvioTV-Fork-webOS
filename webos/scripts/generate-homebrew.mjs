...
const manifest = {
  ...
  appDescription: 'Ajustes alinhados ao fork, temas de cores, AMOLED e aparência de legendas.',
...
const index = { paging: { page: 1, count: 1, maxPage: 1, itemsTotal: 1 }, packages: [{ id: app.id, title: app.title, iconUri: manifest.iconUri, manifest, pool: 'main', shortDescription: 'Player do fork com ajustes, temas e legendas para LG webOS 24.' }] };
