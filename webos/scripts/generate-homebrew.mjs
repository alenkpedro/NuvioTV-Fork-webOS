...
const manifest = {
  ...
  appDescription: 'Pular abertura e créditos, miniaturas locais e aparência de legendas com fonte fixa.',
...
const index = { paging: { page: 1, count: 1, maxPage: 1, itemsTotal: 1 }, packages: [{ id: app.id, title: app.title, iconUri: manifest.iconUri, manifest, pool: 'main', shortDescription: 'Player do fork com trechos e personalização de legendas para LG webOS 24.' }] };
