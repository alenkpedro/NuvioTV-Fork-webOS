...
await writeFile('dist/build-info.json', JSON.stringify({ app: app.id, version: app.version, upstream: 'ysosrs123/NuvioTV-Fork', upstreamCommit: '45e0984c18460d2a65c5d745999011b4314328eb', target: 'LG 55UT8050 / webOS 25', hardwareTested: false }, null, 2));
